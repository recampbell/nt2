...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 boost.simd.arithmetic toolbox - rem/scalar Mode"
...
NT2_TEST_CASE_TPL ( rem_real__2_0,  BOOST_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(rem(boost::simd::Inf<T>(), boost::simd::Zero<T>()), boost::simd::Inf<T>(), 0);
  NT2_TEST_ULP_EQUAL(rem(boost::simd::Zero<T>(), boost::simd::Inf<T>()), boost::simd::Nan<T>(), 0);
  NT2_TEST_ULP_EQUAL(rem(boost::simd::Minf<T>(), boost::simd::Minf<T>()), boost::simd::Nan<T>(), 0);
  NT2_TEST_ULP_EQUAL(rem(boost::simd::Mone<T>(), boost::simd::Mone<T>()), boost::simd::Zero<T>(), 0);
  NT2_TEST_ULP_EQUAL(rem(boost::simd::Nan<T>(), boost::simd::Nan<T>()), boost::simd::Nan<T>(), 0);
  NT2_TEST_ULP_EQUAL(rem(boost::simd::One<T>(), boost::simd::One<T>()), boost::simd::Zero<T>(), 0);
  NT2_TEST_ULP_EQUAL(rem(boost::simd::Zero<T>(), boost::simd::Zero<T>()), boost::simd::Zero<T>(), 0);
  NT2_TEST_ULP_EQUAL(rem(boost::simd::One<T>(), boost::simd::Inf<T>()), boost::simd::Nan<T>(), 0);
  NT2_TEST_ULP_EQUAL(rem(boost::simd::One<T>(), boost::simd::Minf<T>()), boost::simd::Nan<T>(), 0);
  NT2_TEST_ULP_EQUAL(rem(boost::simd::One<T>(), boost::simd::Nan<T>()), boost::simd::Nan<T>(), 0);
