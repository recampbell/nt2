...
{
  /// INTERNAL ONLY - SIMD unaligned_load via Scalar emulation without offset
  ...
  /// INTERNAL ONLY - SIMD unaligned_load via Scalar emulation with offset
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION ( boost::simd::tag::unaligned_load_
                                    , tag::cpu_
                                    , (A0)(A1)(A2)(X)
                                    , (iterator_<unspecified_<A0> >)
  ...
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION_IF( boost::simd::tag::unaligned_load_
                                      , tag::cpu_
                                      , (A0)(A1)(A2)(X)(Y)
                                      , (mpl::equal_to
                                        < boost::simd::meta
                                    ...
                                    )
  {
    ...
    operator()(const A0& a0, const A1& a1, const A2&) const
    {
      ...
      meta::iterate<N>( details::loader< boost::simd::
                                         tag::unaligned_load_(A0, A1, result_type)
                                       >(a0, a1, that)
                      );
      return that;
    }
                                    ...
                                    )
  {
    ...
    operator()(const A0& a0, const A2&) const
    {
      ...
      result_type that;
      meta::iterate<N>( details::loader< boost::simd::
                                         tag::unaligned_load_(A0, result_type)
                                       >(a0, that)
                      );
      return that;
    }
