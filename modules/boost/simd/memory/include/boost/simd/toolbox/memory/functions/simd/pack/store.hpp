...
//==============================================================================
#ifndef BOOST_SIMD_TOOLBOX_MEMORY_FUNCTIONS_SIMD_PACK_STORE_HPP_INCLUDED
#define BOOST_SIMD_TOOLBOX_MEMORY_FUNCTIONS_SIMD_PACK_STORE_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                                    ...
                                    )
  {
    ...
    {
      return boost::simd::store(evaluate(a0),a1,a2);
    }
  };
  /// INTERNAL ONLY pack store with offset
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION ( boost::simd::tag::store_
                                    ...
                                    )
  {
    ...
    {
      return boost::simd::store(evaluate(a0),a1);
    }
  };
} } }
