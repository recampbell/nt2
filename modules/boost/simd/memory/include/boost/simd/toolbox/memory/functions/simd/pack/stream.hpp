...
//==============================================================================
#ifndef BOOST_SIMD_TOOLBOX_MEMORY_FUNCTIONS_SIMD_PACK_STREAM_HPP_INCLUDED
#define BOOST_SIMD_TOOLBOX_MEMORY_FUNCTIONS_SIMD_PACK_STREAM_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                                    ...
                                    )
  {
    ...
    {
      return boost::simd::stream(evaluate(a0),a1,a2);
    }
  };
                                    ...
                                    )
  {
    ...
    {
      return boost::simd::stream(evaluate(a0),a1);
    }
  };
} } }
