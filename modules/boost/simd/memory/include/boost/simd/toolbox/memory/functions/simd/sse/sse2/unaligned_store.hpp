...
{
  /// INTERNAL ONLY - double SIMD unaligned_store with offset
  ...
  /// INTERNAL ONLY - single SIMD unaligned_store with offset
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION ( boost::simd::tag::unaligned_store_
                                    , boost::simd::tag::sse2_
                                    , (A0)(A1)(A2)
                                    , ((simd_ < single_<A0>
  ...
  /// INTERNAL ONLY - integers SIMD unaligned_store with offset
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION ( boost::simd::tag::unaligned_store_
                                    , boost::simd::tag::sse2_
                                    , (A0)(A1)(A2)
                                    , ((simd_ < integer_<A0>
