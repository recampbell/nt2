...
{
  /// INTERNAL ONLY SIMD unaligned store with offset
                                    ...
                                    )
  {
    ...
    BOOST_FORCEINLINE result_type operator()(const A0& a0, A1 a1, A2 a2) const
    {
      ...
      n_t                     MSQ       = vec_ld  ( a2  , ptr );
      __vector unsigned char  edgeAlign = vec_lvsl( a2  , ptr );
      n_t                     LSQ       = vec_ld  ( a2z , ptr );
      __vector unsigned char  align     = vec_lvsr( a2  , ptr );
