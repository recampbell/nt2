...
NT2_TEST_CASE( of_size_concept )
{
  ...
  NT2_TEST_EQUAL( of_size_option.size(), 4 );
  NT2_TEST_EQUAL( of_size_option[0], 3 );
  NT2_TEST_EQUAL( of_size_option[1], 2 );
  NT2_TEST_EQUAL( of_size_option[2], 0 );
  NT2_TEST_EQUAL( of_size_option[3], 5 );
}
