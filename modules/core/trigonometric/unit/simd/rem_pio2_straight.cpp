...
NT2_TEST_CASE_TPL ( rem_pio2_straight_real__1_0,  NT2_SIMD_REAL_TYPES)
{
...

  {
    ...
    vT r1;
    NT2_TEST_EQUAL( rem_pio2_straight(nt2::Pio_2<vT>(), r1), nt2::One<viT>());
    NT2_TEST_ULP_EQUAL( r1, nt2::Zero<vT>(), 0.5);
    NT2_TEST_EQUAL( rem_pio2_straight(nt2::Pio_4<vT>(), r1), nt2::One<viT>());
    NT2_TEST_ULP_EQUAL( r1, -nt2::Pio_4<vT>(), 0.5);
  }
